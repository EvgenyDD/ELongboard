...
void commands_process_packet(unsigned char *data, unsigned int len) {
	...
	case COMM_GET_VALUES:
		...
		buffer_append_float16(send_buffer, NTC_TEMP(ADC_IND_TEMP_MOTOR), 1e1, &ind);
...
//		buffer_append_float32(send_buffer, ADC_GetInjectedConversionValue(ADC1, ADC_InjectedChannel_1), 1e2, &ind);
//		buffer_append_float32(send_buffer, ADC_GetInjectedConversionValue(ADC2, ADC_InjectedChannel_1), 1e2, &ind);
