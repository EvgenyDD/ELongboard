...
void rf_write_tx_payload(const uint8_t *data, int length);
void rf_write_tx_payload_no_ack(const uint8_t *data, int length);
void rf_write_ack_payload(int pipe, const char *data, int length);
void rf_read_rx_payload(uint8_t *data, int length);
