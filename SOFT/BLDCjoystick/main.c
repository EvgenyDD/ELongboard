...
//	BKP_WriteBackupRegister(BKP_DR6, 0);
	...
	upTimeMs = BKP_ReadBackupRegister(REG_UPTIME_SINCE_CHRG_30secQuant)*30;
	...
	// increment on/off counter
	BKP_WriteBackupRegister(REG_ON_OFF_TIMES, BKP_ReadBackupRegister(REG_ON_OFF_TIMES) + 1);
