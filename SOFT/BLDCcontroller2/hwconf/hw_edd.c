...
//	10 - BAT 6
	...
	// ADC1 regular channels
	 ...
	 ADC_RegularChannelConfig(ADC1, ADC_Channel_8, 2, ADC_SampleTime_15Cycles);		//3
	ADC_RegularChannelConfig(ADC1, ADC_Channel_Vrefint, 3, ADC_SampleTime_15Cycles);//6
	 ADC_RegularChannelConfig(ADC1, ADC_Channel_10, 4, ADC_SampleTime_15Cycles);		//9
	...
	// ADC2 regular channels
	 ...
	 ADC_RegularChannelConfig(ADC2, ADC_Channel_9, 2, ADC_SampleTime_15Cycles);		//4
	 ADC_RegularChannelConfig(ADC2, ADC_Channel_4, 3, ADC_SampleTime_15Cycles);		//7
	 ADC_RegularChannelConfig(ADC2, ADC_Channel_14, 4, ADC_SampleTime_15Cycles);		//10
	...
	// ADC3 regular channels
	 ...
	 ADC_RegularChannelConfig(ADC3, ADC_Channel_14, 2, ADC_SampleTime_15Cycles);		//5
