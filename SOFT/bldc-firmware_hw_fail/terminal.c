...
void terminal_process_string(char *str) {
	...
	if (strcmp(argv[0], "ping") == 0) {
	    ...
	    commands_printf("V1: %.3f\n", (double)GET_CELL_POINT_1());
	    commands_printf(" cnt: %d\n", ADC_Value[ADC_IND_CELL1]);
        commands_printf("V2: %.3f\n", (double)GET_CELL_POINT_2());
        commands_printf(" cnt: %d\n", ADC_Value[ADC_IND_CELL2]);
        commands_printf("V3: %.3f\n", (double)GET_CELL_POINT_3());
        commands_printf(" cnt: %d\n", ADC_Value[ADC_IND_CELL3]);
        commands_printf("V4: %.3f\n", (double)GET_CELL_POINT_4());
        commands_printf(" cnt: %d\n", ADC_Value[ADC_IND_CELL4]);
        commands_printf("V5: %.3f\n", (double)GET_CELL_POINT_5());
        commands_printf(" cnt: %d\n", ADC_Value[ADC_IND_CELL5]);
        commands_printf("V6: %.3f\n", (double)GET_CELL_POINT_6());
        commands_printf(" cnt: %d\n", ADC_Value[ADC_IND_CELL6]);
        for(uint8_t i=0; i<6; i++)
            commands_printf(" xxx: %d - %d\n", i, stata[i]);
	}
